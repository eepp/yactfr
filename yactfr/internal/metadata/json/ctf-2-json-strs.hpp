...
static constexpr auto BIO = "bit-order";
...
static constexpr auto FL_BIT_MAP = "fixed-length-bit-map";
...
static constexpr auto FTL = "first-to-last";
...
static constexpr auto LTF = "last-to-first";
