...
class VariableLengthSignedEnumerationBeginningElement;
class VariableLengthSignedIntegerBeginningElement;
class VariableLengthUnsignedEnumerationBeginningElement;
class VariableLengthUnsignedIntegerBeginningElement;
class VariableLengthBitArrayEndElement;
class VariableLengthSignedEnumerationEndElement;
class VariableLengthSignedIntegerEndElement;
class VariableLengthUnsignedEnumerationEndElement;
...
public:
    ...
    virtual void visit(const VariableLengthBitArrayBeginningElement&);
    virtual void visit(const VariableLengthSignedEnumerationBeginningElement&);
    virtual void visit(const VariableLengthSignedIntegerBeginningElement&);
    virtual void visit(const VariableLengthUnsignedEnumerationBeginningElement&);
    virtual void visit(const VariableLengthUnsignedIntegerBeginningElement&);
    virtual void visit(const VariableLengthBitArrayEndElement&);
    virtual void visit(const VariableLengthSignedEnumerationEndElement&);
    virtual void visit(const VariableLengthSignedIntegerEndElement&);
    virtual void visit(const VariableLengthUnsignedEnumerationEndElement&);
    virtual void visit(const VariableLengthUnsignedIntegerEndElement&);
