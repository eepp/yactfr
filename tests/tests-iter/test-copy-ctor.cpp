...
int main()
{
    ...
    while (true) {
        ...
        yactfr::PacketSequenceIterator psItCopy {psIts.back()};

        // this actually calls yactfr::PacketSequenceIterator::operator=() too
    ...
    yactfr::PacketSequenceIterator itCopy {end};
